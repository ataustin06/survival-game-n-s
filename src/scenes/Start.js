...
const CONDITION_CONFIGS = Object.freeze({
    ...
    sufficiency: Object.freeze({
        code: 'sufficiency',
        initialAllocation: Object.freeze([
            3, 3, 3, 6, 9, 9, 12, 15, 18, 42
        ]),
        totalUnits: 120,
        manipulationCorrectAnswer: 'yes',
        equalUnitsPerFamily: 12,
        equalFamiliesMeetingNeed: 10,
        partialMaximumFamilies: 10,
        availableIncomeText:
            'There are 120 income blocks divided among these 10 families.',
        boardAvailableText:
            '120 income blocks available'
    })
});
...
const REDISTRIBUTION_QUESTIONS = Object.freeze([
    ...
    },
    {
        ...
        prompt:
            'Thinking about the American economy as shown in this scenario, should income above the basic-needs line be redistributed to allow the greatest possible number of families to have at least $75,000, or should each family keep its starting income?',
        options: [
            {
                code: 'partial',
                title: 'Redistribute to meet basic needs',
                detail:
                    'Redistribute income held above the basic-needs line so that the greatest possible number of families have at least $75,000.'
            },
            {
                code: 'keep',
                title: 'Keep incomes as they are',
    ...
    showIncomeDifferencesIntroduction ()
{
    ...
    showBasicNeedsThreshold ()
    {
        ...
        this.addScreenText(
            640,
            125,
            'A family of four needs about $75,000 a year to meet its basic needs in the United States today. \n \n These needs include food, housing, and basic medical care.',
            27,
            COLORS.ink,
            930,
            'center'
        ...
        this.addScreenText(
            640,
            515,
            'In this game, ten income blocks represents $75,000.',
            27,
            COLORS.ink,
            860,
            'center'
...
showBasicNeedsComprehensionCheck ()
{
    ...
    this.addScreenText(
        640,
        175,
        'According to the game, how many income blocks represent $75,000?',
        29,
        COLORS.ink,
        880,
        'center'
...
showCorrectBasicNeedsFeedback ()
{
    ...
    this.addScreenText(
        640,
        220,
        'In this game, 10 income blocks represent $75,000.',
        27,
        COLORS.ink,
        760,
        'center'
...
showAboveAndBelowThreshold ()
{
    ...
    this.addScreenText(
        640,
        95,
        'Some families\' incomes are more than $75,000, while others are less.\n',
        27,
        COLORS.ink,
        980,
        'center'
    ...
    this.addScreenText(
        640,
        127,
        'The purple line represents the $75,000 a family needs to meet its basic needs.',
        27,
        COLORS.ink,
        920,
        'center'
...
showRepresentativeFamilyExplanation ()
{
    ...
    showBottomDecile ()
    {
        ...
        this.addScreenText(
            640,
            575,
            'Their yearly income falls below the $75,000 basic-needs line.',
            27,
            COLORS.ink,
            880,
            'center'
    ...
    showTopDecile ()
    {
        ...
        this.addScreenText(
            640,
            570,
            'Their yearly income extends above the $75,000 basic-needs line.',
            27,
            COLORS.ink,
            900,
            'center'
    ...
    showCollectiveThresholdExplanation ()
{
    ...
    this.addScreenText(
        640,
        95,
        'Each family needs 10 income blocks to reach the $75,000 basic-needs line.',
        29,
        COLORS.ink,
        1000,
        'center'
...
showAvailableIncomeDistribution ()
{
    ...
    showManipulationCheck ()
    {
        ...
        this.addScreenText(
            640,
            245,
            'Considering all the income available across the 10 families, is there enough total income for every family to have at least $75,000?',
            27,
            COLORS.ink,
            900,
            'center'
...
this.showFinalScreen();
    ...
    showFreeAllocationInstructions ()
    {
        ...
        this.addScreenText(
            640,
            65,
            'Practice moving one income unit',
            34,
            COLORS.ink,
            950,
            'center'
    ...
    redrawAllocationBoard ()
    {
        ...
        const boardTitles = {
            ...
            partial: 'Allow the greatest possible number of families to reach $75,000',
            self_interest:
...
else if (mode === 'partial')
{
    selectionMessage =
        isAutomaticPartialAllocation
            ? `${meetingNeed} of 10 families now have at least $75,000.`
...
else
{
    selectionMessage =
        ...
        this.addScreenText(
            45,
            578,
            `${meetingNeed} of 10 families have at least $75,000`,
            21,
            COLORS.ink,
            470,
            'left'
            ...
            if (this.allocationMode === 'self_interest')
{
    ...
    showEqualDivisionOutcomeQuestion ()
    {
        ...
        this.addScreenText(
            640,
            160,
            'After dividing the income equally, how many of the 10 families had at least $75,000?',
            29,
            COLORS.ink,
            900,
            'center'
